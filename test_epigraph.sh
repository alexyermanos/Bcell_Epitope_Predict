...
python3 src/epigraph_inference.py --pdb 1cfi --device cuda --pdb_path test_data/PDB --save_path test_data/PDB_Processed --model_path src/EpiGraph/checkpoint --out_path test_data/test_output
