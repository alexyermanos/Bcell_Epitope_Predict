...
```r
shiny::runApp(appDir = "[filepath]/viewbepi_app.R", launch.browser = TRUE)
```

3. In the app, select your local [pdb].pdb file and the [pdb]_merged.csv output file generated by the pipeline.
